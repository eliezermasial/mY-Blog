    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Compte securisé</h1>
                            <span class="subheading">vous n'avez pas l'accés à ce compte au moins que vous soyez l'utilisateur.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <h3 class="fw-bold">connectez-vous</h3>
                        
                        <div class="my-5">
                            <form id="contactForm" action="modificationInfo.php" method="POST" data-sb-form-api-token="API_TOKEN">
